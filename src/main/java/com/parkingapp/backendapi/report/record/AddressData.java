...
public record AddressData(
    ...
    @Valid @NotNull(message = "Location coordinates are required") CoordinatesData location,
    @Valid @NotNull(message = "Jurisdiction data is required") JurisdictionData jurisdiction) {}
